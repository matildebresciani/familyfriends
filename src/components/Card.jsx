        ...
        <div className=" rounded-2xl shadow-lg">
            ...
            <div className="flex flex-col px-4 py-3">
                <div className="flex flex-row justify-between items-end">
                    <h3 className="text-2xl font-medium text-black">Harry</h3>
                    <p className="text-grey">Young</p>
                </div>
                <p className="text-grey max-w-[50%] leading-tight mt-1">Yorkshire terrier</p>
            </div>
        </div>
     );
}
